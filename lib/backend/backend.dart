...
/// Functions to query DriveRecords (as a Stream and as a Future).
Future<int> queryDriveRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      DriveRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<DriveRecord>> queryDriveRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      DriveRecord.collection,
      DriveRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<DriveRecord>> queryDriveRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
