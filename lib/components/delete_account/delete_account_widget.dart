      ...
      child: Padding(
        ...
        child: StreamBuilder<List<AppinfoRecord>>(
          ...
          builder: (context, snapshot) {
            ...
            List<AppinfoRecord> columnAppinfoRecordList = snapshot.data!;
            // Return an empty Container when the item does not exist.
            if (snapshot.data!.isEmpty) {
              return Container();
            }
            final columnAppinfoRecord = columnAppinfoRecordList.isNotEmpty
                ? columnAppinfoRecordList.first
                : null;
                            ...
                            children: [
                              Expanded(
                                child: Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'yaxe7q8v' /* Are you sure you want to delet... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      await columnAppinfoRecord!.reference
                                          .delete();
                                    ...
                                    options: FFButtonOptions(
                                      ...
                                      hoverTextColor: Color(0xFFFF303D),
                                      hoverElevation: 3.0,
                                    ),
                                  ),
                                ),
