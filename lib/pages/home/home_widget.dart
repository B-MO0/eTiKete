  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (FFAppState().AccessToken != null && FFAppState().AccessToken != '') {
        _model.storagedata = await DriveSpaceCall.call(
        ...
        await actions.getAndUpdateRefreshToken(
          context,
          'dummy',
        );
        if (FFAppState().RefreshToken != null &&
            FFAppState().RefreshToken != '') {
          _model.refreshed = await GetAccessTokenFromRefreshTokenCall.call(
            refreshToken: FFAppState().RefreshToken,
          );

          if ((_model.refreshed?.succeeded ?? true)) {
            FFAppState().AccessToken = getJsonField(
              (_model.refreshed?.jsonBody ?? ''),
              r'''$.access_token''',
            ).toString().toString();
            safeSetState(() {});
                                              ...
                                              Padding(
                                                ...
                                                child: StreamBuilder<
                                                  ...
                                                  builder: (context, snapshot) {
                                                    ...
                                                    List<AppinfoRecord>
                                                        containerAppinfoRecordList =
                                                        snapshot.data!;
                                                    final containerAppinfoRecord =
                                                        containerAppinfoRecordList
                                                                .isNotEmpty
                                                            ? containerAppinfoRecordList
                                                                .first
                                                                ...
                                                                children: [
                                                                  Text(
                                                                    FFLocalizations.of(
                                                                            context)
                                                                        .getText(
                                                                      'saxskj92' /* Total Tickets Created */,
                                                                    ),
                                                                    style: FlutterFlowTheme.of(
                                                                            context)
                                                                        .bodySmall
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: StreamBuilder<
                                                        ...
                                                        builder: (context,
                                                          ...
                                                          List<AppinfoRecord>
                                                              columnAppinfoRecordList =
                                                              snapshot.data!;
                                                          final columnAppinfoRecord =
                                                              columnAppinfoRecordList
                                                                      .isNotEmpty
                                                                  ? columnAppinfoRecordList
                                                                      .first
                                                                                    ...
                                                                                    child: TextFormField(
                                                                                      ...
                                                                                      decoration: InputDecoration(
                                                                                        ...
                                                                                        hintText: FFLocalizations.of(context).getText(
                                                                                          'prdvh1ov' /* Please enter event name... */,
                                                                                        ),
                                                                                    ...
                                                                                    child: StreamBuilder<List<AppinfoRecord>>(
                                                                                      ...
                                                                                      builder: (context, snapshot) {
                                                                                        ...
                                                                                        return FFButtonWidget(
                                                                                          onPressed: (_model.eventNameTextController.text == null || _model.eventNameTextController.text == '')
                                                                                              ? null
                                                                                              : () async {
                                                                                                  ...
                                                                                                  await columnAppinfoRecord!.reference.update({
                                                                                                    ...mapToFirestore(
                                                                                                      {
