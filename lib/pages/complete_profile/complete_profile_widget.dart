                          ...
                          Column(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'fyxsf6vn' /* Please complete your profile a... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                                          ...
                                                          decoration:
                                                            ...
                                                            hintText:
                                                                FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                              'rl8ugf4u' /* Enter your phone number here..... */,
                                                            ),
                                                            hintStyle:
                                                                FlutterFlowTheme.of(
                                                                        context)
                                                          ...
                                                          decoration:
                                                            ...
                                                            hintText:
                                                                FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                              'qvxxuqtm' /* Enter your address here... */,
                                                            ),
                                                            hintStyle:
                                                                FlutterFlowTheme.of(
                                                                        context)
                                                        ...
                                                        child: Padding(
                                                          ...
                                                          child: Text(
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              '947xyt76' /* Welcome to eTiKete. By using t... */,
                                                            ),
                                                            textAlign: TextAlign
                                                                .justify,
                                                            style: FlutterFlowTheme
                                                          ...
                                                          children: [
                                                            Expanded(
                                                              child: Padding(
                                                                ...
                                                                child:
                                                                    FFButtonWidget(
                                                                  onPressed: ((_model.phonenumberTextController.text == null || _model.phonenumberTextController.text == '') ||
